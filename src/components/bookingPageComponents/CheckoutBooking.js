            ...
            {!cancel &&
                <div className='step-by-step'>
                    ...
                    <div className='step-item'>
                        {step >= 1 ? <CheckCircleIcon className='holder-step' /> : <span style={{ color: "#ddd", border: "1px solid #ddd" }} className='holder-step'>1</span>}
                        {step !== 1 ? <span style={{ color: "#ddd" }}>Information</span> : <span> Information</span>}
                    </div>

                    {/* step 2 */}
                    <div className='step-item'>
                        {step >= 2 ? <CheckCircleIcon className='holder-step' /> : <span style={{ color: "#ddd", border: "1px solid #ddd" }} className='holder-step'>2</span>}
                    ...
                    {/* step 3 */}
                    <div className='step-item'>
                        {step >= 3 ? <CheckCircleIcon className='holder-step' /> : <span style={{ color: "#ddd", border: "1px solid #ddd" }} className='holder-step'>3</span>}
